...
theme.Header = (function() {
  ...
  var config = {
    ...
    siteHeaderSmallClass: 'site-header--sm',
    siteHeaderRegularClass: 'site-header--reg'
  };
  ...
  function resizeHeader() {
    ...
    $(window).scroll(function() {
      ...
      isScrollingDown = top > scrollPos
        ? false
        : true;
      isWithinThreshold = top < -150;
      scrollPos = top;


      if (isScrollingDown && isWithinThreshold) {
        $(selectors.siteHeader).addClass(config.siteHeaderSmallClass);
      } else {
        $(selectors.siteHeader).removeClass(config.siteHeaderSmallClass);
      }
    });
  }
